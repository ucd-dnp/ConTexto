...
La extracción de los textos de cada archivo tiene una metodología distinta. **ConTexto** facilita el código de importación de textos con la función :py:func:`lectura.leer_texto`.
